...
let url3 =
  "https://www.thesportsdb.com/api/v1/json/{APIKEY}/searchplayers.php?t={India}&p="; //Search for players by name
let url4 =
  "https://www.thesportsdb.com/api/v1/json/3/searchevents.php?e=Arsenal_vs_Chelsea"; //Search for event by event name
...
let url9 =
  "https://www.thesportsdb.com/api/v1/json/3/search_all_leagues.php?c="; //List all Leagues in a country (limited 50 on free tier)
let url10 =
  "https://www.thesportsdb.com/api/v1/json/3/search_all_seasons.php?id=4328"; //List all Seasons in a League
let url11 =
  "https://www.thesportsdb.com/api/v1/json/3/search_all_teams.php?l=English%20Premier%20League"; //List all Teams in a League
let url12 = "https://www.thesportsdb.com/api/v1/json/3/searchloves.php?u=zag"; //List all users loved teams and players
let url13 =
  "https://www.thesportsdb.com/api/v1/json/3/lookupplayer.php?id=34145937"; //Player Details by Id
let url14 =
  "https://www.thesportsdb.com/api/v1/json/3/lookupvenue.php?id=16163"; //Venue Details by Id
let url15 =
  "https://www.thesportsdb.com/api/v1/json/3/lookuphonours.php?id=34147178"; //Player Honours by Player Id
let url16 =
  "https://www.thesportsdb.com/api/v1/json/3/lookupmilestones.php?id=34161397"; //Player Milestones by Player Id
let url17 =
  "https://www.thesportsdb.com/api/v1/json/3/lookupformerteams.php?id=34147178"; //Player Former Teams by Player Id
let url18 =
  "https://www.thesportsdb.com/api/v1/json/3/eventresults.php?id=652890"; //Event Player Results by Event Id
let url19 =
  "https://www.thesportsdb.com/api/v1/json/3/lookuptable.php?l=4328&s=2020-2021"; //Lookup Table by League ID and Season
let url20 =
  "https://www.thesportsdb.com/api/v1/json/3/lookupequipment.php?id=133597"; //Lookup Equipment by Team ID
let url21 =
  "https://www.thesportsdb.com/api/v1/json/3/eventslast.php?id=133602"; //Last 5 Events by Team Id (Limited to home team for free tier)
let url22 =
  "https://www.thesportsdb.com/api/v1/json/3/eventsround.php?id=4328&r=38&s=2014-2015"; //Events in a specific round by league id/round/season
let url23 =
  "https://www.thesportsdb.com/api/v1/json/3/eventsseason.php?id=4328&s=2014-2015"; //All events in specific league by season (Free tier limited to 100 events)
let url24 =
  "https://www.thesportsdb.com/images/media/league/fanart/xpwsrw1421853005.jpg/medium"; //Images
...
let cricurl1 =
  "https://api.cricapi.com/v1/currentMatches?apikey=4fb281f8-4a6c-4529-a79d-346c539f4d89&offset=0";
